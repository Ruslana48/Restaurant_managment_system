...
public class MySqlDishDaoTest {
    ...
    @Test
    void getDishesNumberInCategory() throws SQLException, DbExceptions {
        int expected = 5;
    ...
    @Test
    void getSortedDishesOnPage() throws SQLException, DbExceptions {
    ...
    @Test
    void getSortedDishesFromCategoryOnPage() throws SQLException, DbExceptions {
        Dish actualDish = getTestDishes(1).get(0);
        Utils.mockResultSetForDish(actualDish, resultSet);
    ...
    @Test
    void getDishesNumber() throws SQLException, DbExceptions {
        int expected = 5;
        Mockito.when(resultSet.getInt(1)).thenReturn(expected);
